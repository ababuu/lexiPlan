...
const Sidebar = ({ isOpen, closeSidebar }) => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed lg:relative lg:translate-x-0 inset-y-0 left-0 z-50 w-64 sm:w-72 lg:w-60 bg-[hsl(var(--nav-background))] border-r-[0.5px] border-border h-full flex flex-col backdrop-blur-sm overflow-hidden transition-transform duration-300 ease-in-out ${
